...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📧 [Shipping Email] Order URL:', orderUrl)
    console.log('📧 [Shipping Email] Order ID:', order.id)
    console.log('📧 [Shipping Email] Final URL will be:', `${orderUrl}/orders?orderId=${order.id}`)
