/**
 * Send Delivery Email Script
 * 
 * Usage:
 *   node scripts/send-delivery-email.js <orderId> [force]
 * 
 * Examples:
 *   node scripts/send-delivery-email.js 3a40bb52-98da-4f96-9262-4a7ca2d8e5e3
...
if (!orderId) {
  ...
  console.log('\nUsage: node scripts/send-delivery-email.js <orderId> [force]')
  console.log('Example: node scripts/send-delivery-email.js 3a40bb52-98da-4f96-9262-4a7ca2d8e5e3 force')
  process.exit(1)
}
...
const endpoint = `${baseUrl}/api/send-delivery-email`
